...
<script type="text/javascript" language="javascript"> 
    ...
    var japp_store = createStore(false,'m_to_approve_store',['nomor_entry','tgl_jurnal','referensi','keterangan','jurnal_type'],'<?php echo base_url(); ?>' + 'entry_jurnal/get_row_approval');
