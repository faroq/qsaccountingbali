            ...
            <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/style/mainstyle.css'); ?>">            
                ...
                <script type="text/javascript">
                    ...
                    function to_print(domid,url){      
                        Ext.getDom(domid).src ='<?php echo base_url(); ?>' + url;
                    }
                    ...
                    function definWinPrint(winname,winid,alias,title,idprint){
                        Ext.define(winname, {
                            extend          : 'Ext.window.Window',
                            title           : title,
                            width           : 900,
                            ...
                            id              : winid,
                            maximizable     :true,
                            html:'<iframe style="width:100%;height:100%;" id="'+idprint+'" src=""></iframe>'
