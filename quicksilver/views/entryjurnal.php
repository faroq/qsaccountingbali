...
<script type="text/javascript" language="javascript"> 
    ...
    var jurnaltype_store=createStore(false, 'mjurnaltype_store', [
        'id',
        'jurnal_type',        
    ], '<?php echo base_url(); ?>' + 'global_reference/get_jurnal_type');
                ...
                items:[
                    {
                        ...
                        ,items :[{
                                ...
                                afterLabelTextTpl: required_css,
                                fieldLabel: 'Jurnal_type',                        
                                id: 'jurnaltype_ej',
                                mode:'local',
                                store:jurnaltype_store,
                                valueField: 'jurnal_type',
                                displayField: 'jurnal_type',
                                typeAhead: true,
                                triggerAction: 'all',                    
                                allowBlank: false,
                                editable: false,
                                anchor: '90%',
                                hiddenName: 'jurnal_type'
                                ,
                                emptyText: 'Jurnal Type'              
                            }
                            //                                                        ,{xtype: 'twincombo',
                            //                                                            name: 'keterangan',
                            //                                                            fieldLabel: 'Keterangan',
