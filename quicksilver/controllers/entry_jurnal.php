...
class entry_jurnal extends MY_Controller {
    ...
    public function update_rows() {
        ...
        $jurnal_type = isset($_POST['jurnal_type']) ? $this->db->escape_str($this->input->post('jurnal_type', TRUE)) : '';
        ...
        $param=array($opt,$vnomor_entry,$tgl_jurnal,$referensi,$keterangan,$jurnal_type,$jurnal_by);
