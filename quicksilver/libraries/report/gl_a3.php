...
/**
 * Description of gl_a3
 *
 * @author miyzan
 */
class gl_a3 extends MY_FPDF {
    //put your code here
    function Header()
    {
            //Logo
...
//            $this->Cell(130);
            ...
            $this->SetY(32);
            $this->Cell(400,5,$this->dataheader[1],0,0,'L',false);
            //Line break
            $this->Ln(1);
    }
...
//                    $this->SetFillColor(205,205,0);
                    ...
                    $this->SetDrawColor(0);
                    $this->Cell($w[0]+$w[1]+$w[2]+$w[3]+$w[4]+$w[5],5,'Rekening : '.$json[$i]['rekening'],'B',0,'L',$fill);
                    $this->SetFont('Arial','',10);
                    $this->Ln();
                }
